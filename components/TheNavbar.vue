        ...
        <div class="px-4">
          <div class="mx-auto container">
            <div class="relative flex items-center justify-between gap-5 py-4">
              <router-link to="/" class="relative shrink-0">
                <figure>
                  <img
                    class="w-32"
              ...
              >
                ...
                >
                  ...
                  <li>
                    <router-link to="/ultra-low-latency-vps">
                      <span class="font-bold text-base xl:text-xl text-black">
                        BROKER LATENCY
                      </span>
                    </router-link>
                  ...
                  <li>
                    <router-link to="/pricing#excl-vps">
                      <span class="font-bold text-base xl:text-xl text-black">
                        EXCL VPS
                      </span>
                    </router-link>
                  ...
                  <li>
                    <router-link to="/dedicated-server">
                      <span class="font-bold text-base xl:text-xl text-black"
